layui.use(['laydate','table','form','layer'], function(){
    ...
    table.render({
        ...
        ,cellMinWidth:'60'
        ,cols: [[ //表头
            {field: 'userName', title: '登录名称', sort: true, fixed: 'left'}
            ...
            ,{field: 'oaDept', title: '部门', templet:function (d) {
                return d.oaDept.name }}
            ,{field: 'oaPost', title: '岗位',templet:function (d) {
                return d.oaPost.name  }}
            ,{field: 'dimiDate', title: '离职时间',templet: function(d){
                    return Format(d.dimiDate,'yyyy-MM-dd')}}
        ]]
        ,request:{
